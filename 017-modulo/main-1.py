...
def sprawdz_podzielnosc(a, b):
    return (
        a % b == 0
    )  # zwróć wartość logiczną wyrażenia: reszta z dzielenia a przez b wynosi 0
...
def sprawdz_niepodzielnosc(a, b):
    return a % b != 0


print(sprawdz_niepodzielnosc(10, 5))
print(sprawdz_niepodzielnosc(10, 3))
print(sprawdz_niepodzielnosc(1000, 7))
