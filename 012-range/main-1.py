...
A = list(
    range(1, 11)
)  # tworzy listę od range w zakresie od 1 do 10 włącznie (11 nie wchodzi w sekwencję)
print(A)

B = list(
    range(100, 0, -3)
)  # tworzy listę od range w zakresie co trzeciego elementu od 100 do 1 włącznie (0 nie wchodzi w sekwencję),
print(B)
