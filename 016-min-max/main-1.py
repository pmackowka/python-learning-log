# Pytanie 17 - znajdź różnicę między największą a najmniejszą wartością na poniższej liście.
...
print(
    A[-1] - A[0]
)  # drukowanie różnicy między ostatnim, a pierwszym elementem posortowanej listy A
...
)  # wydrukuj różnicę między zmienną największa a najmniejsza
